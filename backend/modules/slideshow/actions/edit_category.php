 ...
 * @since		1.0
 */
class BackendSlideshowEditCategory extends BackendBaseActionEdit
{
	/**
	 * Execute the action
	 *
	...
	protected function parse()
	{
		...
		if(BackendSlideshowModel::isCategoryAllowedToBeDeleted($this->id)) $this->tpl->assign('showDelete', true);
	}
